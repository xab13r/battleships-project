...
RSpec.describe UserInterface do
  describe '#start_the_game' do
    ...
    it "fails if board dimensions are not the same for both player (columns)" do
      ...
      expect { UserInterface.new(io, player_1, player_2) }.to raise_error "Board dimensions need to be the same for both players"
    end
    ...
    it "fails if both players don't have the same number of ships" do
      ...
      expect { UserInterface.new(io, player_1, player_2) }.to raise_error "Both players must have the same number of ships"
    end
